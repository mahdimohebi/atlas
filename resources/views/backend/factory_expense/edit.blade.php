            ...
            <div>
                <nav>
                    <ol class="breadcrumb mb-0">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">ویرایش مصرف کارخانه</li>
                    </ol>
                </nav>
            </div>
        </div>
            ...
            <div class="col-12">
                <div class="card custom-card">
                    <div class="card-body">
                        ...
                        <form action="{{ route('factory_expenses.update', $expense->id) }}" method="POST">
                            @csrf
                            @method('PUT')
                            <div class="row gy-4">
                                ...
                                <div class="col-md-6 col-sm-12">
                                    ...
                                    <input type="text" name="price" id="price" class="form-control" value="{{ $expense->price }}" required>
                                    @error('price')
                                        <p class="text-danger">{{ $message }}</p>
                                    @enderror
                                </div>
