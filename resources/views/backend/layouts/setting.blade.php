                    ...
                    <div class="tab-pane fade border-0" id="switcher-profile" role="tabpanel" aria-labelledby="switcher-profile-tab" tabindex="0">
                        <div>
                            <div class="theme-colors">
                                ...
                                <div class="px-4 pb-3 text-muted fs-11">توجه: 
                                    اگر می خواهید رنگ را تغییر دهید، منو به صورت پویا تغییر می کند
 از زیر انتخابگر رنگ اصلی تم</div>
                            </div>
                            <div class="theme-colors">
 ...
 از زیر انتخابگر رنگ اصلی تم</div>
                            ...
                            <div class="theme-colors">
                                <p class="switcher-style-head">موضوع اصلی:</p>
                            ...
                            <div class="theme-colors">
                                <p class="switcher-style-head">پس زمینه تم:</p>
                                <div class="d-flex flex-wrap align-items-center switcher-style">
                                    <div class="form-check switch-select me-3">
                    ...
                    <div class="d-flex justify-content-between canvas-footer gap-1"> 
                        <a href="#" target="_blank" class="btn btn-primary flex-fill">خرید</a> 
                        <a href="#" target="_blank" class="btn btn-secondary flex-fill">نمونه کار</a> 
                        <a href="javascript:void(0);" id="reset-all" class="btn btn-danger flex-fill">بازنشانی</a> 
                    </div>
                </div>
            </div>
