                        ...
                        <form action="{{ route('salary.update', $salary->id)  }}" method="POST">
                            ...
                            <div class="row gy-4">
                                ...
                                <div class="col-md-6 col-sm-12">
                                    ...
                                    <input type="text" class="form-control" name="amount" id="amount" value="{{ old('amount', isset($salary) ? $salary->amount : '') }}">
                                    @error('amount')
                                ...
                                <div class="col-md-6 col-sm-12">
                                    ...
                                    <input type="date" class="form-control" name="date" id="date" value="{{ old('date', isset($salary) ? $salary->date : '') }}">
                                    @error('date')
                                        <p class="text-danger">{{ $message }}</p>
                                    @enderror
                                </div>
                                ...
                                <div class="col-md-6 col-sm-12">
                                    ...
                                    <select name="status" class="form-control">
                                        ...
                                        <option value="1" {{ $salary->status == 1 ? 'selected' : '' }}>پرداخت شده</option>
                                        <option value="0" {{ $salary->status == 0 ? 'selected' : '' }}>پرداخت نشده</option>
                                    </select>
                                    @error('status')
                                        <p class="text-danger">{{ $message }}</p>
                                    @enderror
                                ...
                                <div class="col-md-6 col-sm-12">
                                    ...
                                    <input type="text" class="form-control" name="notes" id="notes" value="{{ old('notes', isset($salary) ? $salary->notes : '') }}">
                                    @error('notes')
                                        <p class="text-danger">{{ $message }}</p>
                                    @enderror
                                </div>
                                ...
                                <div class="col-12 text-center">
                                    <input type="submit" class="btn btn-success" value="{{ isset($salary) ? 'بروزرسانی معاش' : 'ثبت معاش' }}">
                                </div>
