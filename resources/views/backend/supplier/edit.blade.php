            ...
            <div>
                <nav>
                    <ol class="breadcrumb mb-0">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">ویرایش فروشندگان</li>
                    </ol>
                </nav>
            </div>
        </div>
                        ...
                        <form action="{{ route('supplier.update', ['supplier' => $supplier->id]) }}" method="POST">
                            ...
                            <div class="row gy-4">
                                ...
                                <div class="col-md-6 col-sm-12">
                                    ...
                                    <input type="text" class="form-control" name="f_name" id="f_name" value="{{ $supplier->f_name }}">
                                    @error('f_name')
                                        <p class="text-danger">{{ $message }}</p>
                                    @enderror
                                </div>
                                ...
                                <div class="col-md-6 col-sm-12">
                                    ...
                                    <input type="tel" class="form-control" name="phone" id="phone" value="{{ $supplier->phone }}">
                                    @error('phone')
                                        <p class="text-danger">{{ $message }}</p>
                                    @enderror
                                </div>
